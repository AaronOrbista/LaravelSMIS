    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.suppliers.update", [$supplier->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group col-sm-4">
                ...
                <input class="form-control {{ $errors->has('tin_number') ? 'is-invalid' : '' }}" name="tin_number" id="tin_number" value="{{ old('tin_number', $supplier->tin_number) }}" required>
            ...
            <div class="form-group col-sm-8">
                ...
                <input class="form-control {{ $errors->has('contact_number') ? 'is-invalid' : '' }}" name="contact_number" id="contact_number" value="{{ old('contact_number', $supplier->contact_number) }}" required>
